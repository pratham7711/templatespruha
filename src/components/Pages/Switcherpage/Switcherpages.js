  ...
  return (
    <Fragment>
      <div className="page-header">
        <div>
          <h2 className="main-content-title tx-24 mg-b-5">Switcher Page</h2>
          <Breadcrumb>
            <Breadcrumb.Item href="#">Pages</Breadcrumb.Item>
            <Breadcrumb.Item active>Switcher Page</Breadcrumb.Item>
          </Breadcrumb>
        </div>
...
Switcherpage.propTypes = {};

Switcherpage.defaultProps = {};
