          ...
          <Row className="row-sm">
            ...
            <Col xl={6} lg={6} md={12} sm={12}>
              <div className="text-xl-end text-center">
                <img src={require("../../../assets/img/media/team.png")} alt="img" className="rounded-5" />
              </div>
            </Col>
          </Row>
        </Col>
        ...
        <Col xl={3} lg={6} md={6} sm={6}>
          <Card className="custom-card our-team">
            <Card.Body>
              ...
              <div className="text-center mt-3">
                <Link to="#" target="_blank" className="btn btn-sm ripple bg-primary-transparent text-primary rounded-circle me-1">
                  <i className="mdi mdi-facebook"></i>
                </Link>
                <Link to="#" target="_blank" className="btn btn-sm ripple bg-danger-transparent text-danger rounded-circle me-1">
                  <i className="mdi mdi-google"></i>
                </Link>
                <Link to="#" target="_blank" className="btn btn-sm ripple bg-info-transparent text-info rounded-circle">
